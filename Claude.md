...
**我用产品视角描述问题，不用技术术语。** 我说的是"看起来是什么样"，不是"代码怎么写"。所有回复必须翻译成视觉效果，不要堆技术名词。
...
4. **跟我解释时，只说"会看到什么效果"，不说技术名词。**
   - ❌ 不说："min-content-width 传递到 flex container"
   - ✅ 要说："展开的卡会变得和折叠的一样宽，放大效果消失"
   - CSS、flex、min-width、contain 这些词对我来说没有意义，说了等于没说。
